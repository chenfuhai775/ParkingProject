namespace Parking.Drives
{
    ...
    public class LNX_SDK_Operation_X86
    {
        private static bool InitializeFlag = false;
        private static bool InitializeSucceFlag = false;
        private static lnk_sdk_interface.LNX_SDK_Interface_X86.default_send_callback_def m_default_send_callback_def;
        private static lnk_sdk_interface.LNX_SDK_Interface_X86.DeviceStatusCallBack m_DeviceStatusCallBack;
        private static lnk_sdk_interface.LNX_SDK_Interface_X86.gate_event_callback m_gate_event_callback;
        private static lnk_sdk_interface.LNX_SDK_Interface_X86.NetStatusCallBack m_NetStatusCallBack;
        private static lnk_sdk_interface.LNX_SDK_Interface_X86.send_read_device_info_callback_def m_send_read_device_info_callback_def;
        ...
        public static bool BarrierSend(int devhandle, int command)
        {
            ...
            if (command == 2)
            {
                seq = lnk_sdk_interface.LNX_SDK_Interface_X86.stop_gate(nethandle, devhandle, 300, 3, m_default_send_callback_def, errmsg, 500);
                if (seq == -1)
                {
                    return false;
                }
            ...
            if (command == 1)
            {
                seq = lnk_sdk_interface.LNX_SDK_Interface_X86.open_gate(nethandle, devhandle, 300, 3, m_default_send_callback_def, errmsg, 500);
                if (seq == -1)
                {
                    return false;
                }
            ...
            if (command == 0)
            {
                seq = lnk_sdk_interface.LNX_SDK_Interface_X86.close_gate(nethandle, devhandle, 300, 3, m_default_send_callback_def, errmsg, 500);
                if (seq == -1)
                {
                    return false;
                }
        ...
        public static bool CloseDev(string ip)
        {
            ...
            IntPtr errmsg = new IntPtr();
            if (lnk_sdk_interface.LNX_SDK_Interface_X86.close_device(handle, errmsg) < 0)
            {
                return false;
            }
            return true;
        ...
        {
            return lnk_sdk_interface.LNX_SDK_Interface_X86.close_device_info_handle(infohandle);
        }

        public static int CreateDev(string ip, int port)
        {
            IntPtr errmsg = new IntPtr();
            int devhandle = lnk_sdk_interface.LNX_SDK_Interface_X86.create_device(-1, enumDevType.LX_PCUFZ01, ip, port, errmsg);
            int num2 = lnk_sdk_interface.LNX_SDK_Interface_X86.set_device_alive_status_callback(nethandle, devhandle, 0x1388, m_DeviceStatusCallBack);
            int num3 = lnk_sdk_interface.LNX_SDK_Interface_X86.set_gate_event_callback(nethandle, devhandle, m_gate_event_callback);
            return devhandle;
        }

        public static int CreateDeviceInfo()
        {
            return lnk_sdk_interface.LNX_SDK_Interface_X86.create_device_info_handle();
        }
        ...
        private static unsafe int gate_event_callbackPro(int nethandle, int devhandle, int gate_id, IntPtr pevent, int event_cnt, int event_handle)
        {
            ...
            if (devhandle >= 0)
            {
                ...
                lnk_sdk_interface.LNX_SDK_Interface_X86.read_device_handle(devhandle, 3, valuetype, ptr, destination);
            ...
            if (event_cnt > 0)
            {
                ...
                for (int i = 0; i < event_cnt; i++)
                {
                    ...
                    if ((numArray[i] == 4) || (numArray[i] == 5))
                    {
                        ...
                        LNK_BARRIER_ISDK_X86.ExuteDelegate(3, args);
                    }
                    if (numArray[i] == 14)
                    {
                        ...
                        LNK_BARRIER_ISDK_X86.ExuteDelegate(2, args2);
                    }
                    if (numArray[i] == 15)
                    {
                        args2 = DevInstanceMgr.DevFindDeviceMonitorEventArgs(roadgate_info_struct.ip);
            ...
            if (event_handle >= 0)
            {
                ...
                int num3 = 0;
                num = 4;
                if ((lnk_sdk_interface.LNX_SDK_Interface_X86.read_gate_event(nethandle, devhandle, gate_id, event_handle, 11, &num3, (void*) &num4, &num) == 0) && ((num3 == 1) && (num == 4)))
                {
        ...
        {
            return lnk_sdk_interface.LNX_SDK_Interface_X86.init_device_info_handle(infohandle, infoid, value, valuetype);
        }
        ...
        public static bool Initialize()
        {
            ...
            if (!SeqProThreadStartFlag)
            {
                ...
                ThreadPool.QueueUserWorkItem(new WaitCallback(LNX_SDK_Operation_X86.SEQOutTimeRemovePro));
            }
            if (InitializeFlag)
            {
                return InitializeSucceFlag;
            }
            m_NetStatusCallBack = new lnk_sdk_interface.LNX_SDK_Interface_X86.NetStatusCallBack(LNX_SDK_Operation_X86.NetStatusCallBackPro);
            m_gate_event_callback = new lnk_sdk_interface.LNX_SDK_Interface_X86.gate_event_callback(LNX_SDK_Operation_X86.gate_event_callbackPro);
            m_DeviceStatusCallBack = new lnk_sdk_interface.LNX_SDK_Interface_X86.DeviceStatusCallBack(LNX_SDK_Operation_X86.DeviceStatusCallBackPro);
            m_default_send_callback_def = new lnk_sdk_interface.LNX_SDK_Interface_X86.default_send_callback_def(LNX_SDK_Operation_X86.default_send_callback_defPro);
            m_send_read_device_info_callback_def = new lnk_sdk_interface.LNX_SDK_Interface_X86.send_read_device_info_callback_def(LNX_SDK_Operation_X86.send_read_device_info_callback_defPro);
            bool flag = true;
            if (lnk_sdk_interface.LNX_SDK_Interface_X86.start_application() != 0)
            {
                flag = false;
                InitializeSucceFlag = false;
                return flag;
            }
            nethandle = lnk_sdk_interface.LNX_SDK_Interface_X86.create_comm_interface(1, GetRealIP(), 0x1388, errmsg);
            if (nethandle < 0)
            {
                flag = false;
                InitializeSucceFlag = false;
        ...
        public static bool LEDSend(int devhandle, LED_PARAMETER_STRUCT param)
        {
            ...
            if (param.Msg != null)
            {
                ...
                if ((param.Msg.Length + param.rowIndex) > 5)
                {
                    ...
                    seq = lnk_sdk_interface.LNX_SDK_Interface_X86.led_show(nethandle, devhandle, 300, 3, m_default_send_callback_def, errmsg, param.rowIndex, param.fontColor, param.displayMode, staytime, loopcnt, ledtext, 0);
                    if (seq == -1)
                    {
                        return false;
                    }
        ...
        public static bool ModifyDeviceInfo(int devhandle, string deviceName, string ip, int port, string mac)
        {
            ...
            if (s != null)
            {
                ...
                if (flag2 && (lnk_sdk_interface.LNX_SDK_Interface_X86.modify_device_info(nethandle, devhandle, 300, 3, m_default_send_callback_def, errmsg, infohandle) == -1))
                {
                    flag = false;
                }
                Thread.Sleep(0x3e8);
        ...
        private static string read_device_handle(int devhandle)
        {
            ...
            for (int i = 1; i <= 4; i++)
            {
                int num2 = lnk_sdk_interface.LNX_SDK_Interface_X86.read_device_handle(devhandle, i, valuetype, ptr2, valuelen);
        ...
        public static bool UnInitialize()
        {
            ...
            if (lnk_sdk_interface.LNX_SDK_Interface_X86.close_comm_interface(nethandle, errmsg) < 0)
            {
                flag = false;
                UnInitializeSucceFlag = false;
                return flag;
        ...
        public static bool VoiceSend(int devhandle, VOICE_PARAMETER_STRUCT param)
        {
            bool flag = true;
            IntPtr errmsg = new IntPtr();
            int seq = lnk_sdk_interface.LNX_SDK_Interface_X86.voice_cmd(nethandle, devhandle, 300, 3, m_default_send_callback_def, errmsg, param.volume, param.content, 1);
            if (seq == -1)
            {
                return false;
            }
