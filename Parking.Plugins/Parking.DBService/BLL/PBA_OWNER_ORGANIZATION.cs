...
namespace Parking.DBService.BLL
{
	...
	/// 管理停车场业主组织架构管理
	/// </summary>
    public partial class PBA_OWNER_ORGANIZATION : IPBA_OWNER_ORGANIZATION
	{
		private readonly Parking.DBService.DAL.PBA_OWNER_ORGANIZATION dal=new Parking.DBService.DAL.PBA_OWNER_ORGANIZATION();
		...
		/// 获得数据列表
		/// </summary>
		public List<Parking.Core.Model.PBA_OWNER_ORGANIZATION> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Parking.Core.Model.PBA_OWNER_ORGANIZATION> DataTableToList(DataTable dt)
		{
			List<Parking.Core.Model.PBA_OWNER_ORGANIZATION> modelList = new List<Parking.Core.Model.PBA_OWNER_ORGANIZATION>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Parking.Core.Model.PBA_OWNER_ORGANIZATION model;
