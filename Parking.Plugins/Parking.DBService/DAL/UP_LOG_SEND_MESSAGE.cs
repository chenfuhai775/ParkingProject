...
namespace Parking.DBService.DAL
{
	...
	public partial class UP_LOG_SEND_MESSAGE
	{
		...
		public bool Delete()
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from UP_LOG_SEND_MESSAGE ");
			strSql.Append(" where ");
			SqlParameter[] parameters = {
			};
		...
		public Parking.Core.Model.UP_LOG_SEND_MESSAGE GetModel()
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 ID,MSG_TYPE,MSG_STR,CREATE_DATE,MSG_DATE,MSG_SEND_TYPE,MSG_SEQ,RECEIPT_MSG_DATE,RECEIPT_SEQ,RECEIPT_MSG_STR,MSG_STATUS,REMARK from UP_LOG_SEND_MESSAGE ");
			strSql.Append(" where ");
			SqlParameter[] parameters = {
			};

			Parking.Core.Model.UP_LOG_SEND_MESSAGE model=new Parking.Core.Model.UP_LOG_SEND_MESSAGE();
		...
		/// 得到一个对象实体
		/// </summary>
		public Parking.Core.Model.UP_LOG_SEND_MESSAGE DataRowToModel(DataRow row)
		{
			Parking.Core.Model.UP_LOG_SEND_MESSAGE model=new Parking.Core.Model.UP_LOG_SEND_MESSAGE();
			if (row != null)
			{
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM UP_LOG_SEND_MESSAGE ");
			if(strWhere.Trim()!="")
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) FROM UP_LOG_SEND_MESSAGE ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from UP_LOG_SEND_MESSAGE T ");
