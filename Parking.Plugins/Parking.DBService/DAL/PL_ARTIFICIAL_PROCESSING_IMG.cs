...
{
	/// <summary>
	/// 数据访问类:PL_ARTIFICIAL_PROCESSING_IMG
	/// </summary>
	public partial class PL_ARTIFICIAL_PROCESSING_IMG
	{
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(Parking.Core.Model.PL_ARTIFICIAL_PROCESSING_IMG model)
		{
			StringBuilder strSql=new StringBuilder();
			...
			parameters[6].Value = model.Column_7;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Parking.Core.Model.PL_ARTIFICIAL_PROCESSING_IMG model)
		{
			StringBuilder strSql=new StringBuilder();
			...
			parameters[3].Value = model.IMG_TYPE;
			parameters[4].Value = model.CREATE_TIME;
			parameters[5].Value = model.Column_7;
		...
		/// 得到一个对象实体
		/// </summary>
		public Parking.Core.Model.PL_ARTIFICIAL_PROCESSING_IMG GetModel(string ID)
		{
		...
		/// 得到一个对象实体
		/// </summary>
		public Parking.Core.Model.PL_ARTIFICIAL_PROCESSING_IMG DataRowToModel(DataRow row)
		{
			Parking.Core.Model.PL_ARTIFICIAL_PROCESSING_IMG model=new Parking.Core.Model.PL_ARTIFICIAL_PROCESSING_IMG();
			if (row != null)
			{
				...
				if(row["ARTIFICIAL_PROCESSING_ID"]!=null)
				{
					model.ARTIFICIAL_PROCESSING_ID=row["ARTIFICIAL_PROCESSING_ID"].ToString();
				}
				if(row["DEV_ID"]!=null)
				{
				...
				if(row["Column_7"]!=null)
				{
					model.Column_7=row["Column_7"].ToString();
				}
			}
			return model;
		}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,ARTIFICIAL_PROCESSING_ID,DEV_ID,IMG_URL,IMG_TYPE,CREATE_TIME,Column_7 ");
			strSql.Append(" FROM PL_ARTIFICIAL_PROCESSING_IMG ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from PL_ARTIFICIAL_PROCESSING_IMG T ");
