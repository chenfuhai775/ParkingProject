...
namespace Parking.Core.Infrastructure.DependencyManagement
{
    /// <summary>
    /// Container manager
    /// </summary>
            ...
            foreach (var constructor in constructors)
            {
                try
                {
                    ...
                    foreach (var parameter in parameters)
                    {
                        ...
                        if (service == null) throw new LonixException("Unkown dependency");
                        parameterInstances.Add(service);
                    }
                    return Activator.CreateInstance(type, parameterInstances.ToArray());
                }
                catch (LonixException)
                {

                }
            }
            throw new LonixException("No contructor was found that had all the dependencies satisfied.");
        }
