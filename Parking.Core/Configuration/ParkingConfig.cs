...
{
    public partial class ParkingConfig : IConfigurationSectionHandler
    {
        /// <summary>
        ...
        public object Create(object parent, object configContext, XmlNode section)
        {
            ...
            var supportPreviousLonixcommerceVersionsNode = section.SelectSingleNode("SupportPreviousLonixcommerceVersions");
            if (supportPreviousLonixcommerceVersionsNode != null && supportPreviousLonixcommerceVersionsNode.Attributes != null)
            {
                var attribute = supportPreviousLonixcommerceVersionsNode.Attributes["Enabled"];
                if (attribute != null)
                    config.SupportPreviousLonixcommerceVersions = Convert.ToBoolean(attribute.Value);
            }
        ...
        /// <summary>
        /// Indicates whether we should support previous LonixCommerce versions (it can slightly improve performance)
        /// </summary>
        public bool SupportPreviousLonixcommerceVersions { get; private set; }
        ...
        /// <summary>
        /// A list of plugins ignored during LonixCommerce installation
        /// </summary>
